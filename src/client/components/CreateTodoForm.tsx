...
export const CreateTodoForm = () => {
  ...
  return (
    <form className="group flex h-[52px] items-center justify-between rounded-12 border border-gray-200 py-2 pr-4 ">
      ...
      <button
        className="flex h-[36px] w-[67px] items-center justify-center rounded-full bg-[#334155] px-[20px] py-[8px] font-semibold text-white disabled:cursor-not-allowed disabled:opacity-50"
        type="submit"
